...
class EmpresaControllerTest {
        ...
        static final String SENHA_ADMIN_VALIDA = "admin123";
        static final String SENHA_ADMIN_INVALIDA = "adminErrada";

        static final String URI_EMPRESAS = "/empresas";
        ...
        class EmpresaVerificacao {
                ...
                void quandoAlteramosNomeEmpresaAdminECodigoValidos() throws Exception {
                        ...
                        EmpresaResponseDTO resultado = objectMapper.readValue(responseJsonString,
                ...
                void quandoAlteramosNomeEmpresaNuloAdminValido() throws Exception {
                        ...
                        assertAll(
                                        ...
                                        () -> assertEquals("Nome fantasia é obrigatório",
        ...
        class EmpresaVerificacaoFluxosBasicosApiRest {
                ...
                void quandoBuscamosTodasEmpresas() throws Exception {
                        ...
                        List<EmpresaResponseDTO> resultado = objectMapper.readValue(responseJsonString,
                                        new TypeReference<>() {
                                        });
        ...
        class EmpresaVerificacaoAprovacaoReprovacaoTecnico {
                ...
                void quandoAprovamosTecnicoEmpresaInexistente() throws Exception {
                        String responseJsonString = driver
                                        .perform(put(URI_EMPRESAS + "/00000000000000/aprovar/" + tecnico.getId())
                                                        .param("codigo", empresa.getCodigoAcesso()))
                                        .andExpect(status().isBadRequest())
                                        .andDo(print())
                                        .andReturn().getResponse().getContentAsString(StandardCharsets.UTF_8);
                ...
                void quandoAprovamosTecnicoInexistente() throws Exception {
                        String responseJsonString = driver
                                        .perform(put(URI_EMPRESAS + "/" + empresa.getCnpj() + "/aprovar/" + 99999L)
                                                        .param("codigo", empresa.getCodigoAcesso()))
                                        .andExpect(status().isBadRequest())
                                        .andDo(print())
                                        .andReturn().getResponse().getContentAsString(StandardCharsets.UTF_8);
                ...
                void quandoRejeitamosTecnicoEmpresaInexistente() throws Exception {
                        String responseJsonString = driver
                                        .perform(put(URI_EMPRESAS + "/00000000000000/rejeitar/" + tecnico.getId())
                                                        .param("codigo", empresa.getCodigoAcesso()))
                                        .andExpect(status().isBadRequest())
                                        .andDo(print())
                                        .andReturn().getResponse().getContentAsString(StandardCharsets.UTF_8);
                ...
                void quandoRejeitamosTecnicoInexistente() throws Exception {
                        String responseJsonString = driver
                                        .perform(put(URI_EMPRESAS + "/" + empresa.getCnpj() + "/rejeitar/" + 99999L)
                                                        .param("codigo", empresa.getCodigoAcesso()))
                                        .andExpect(status().isBadRequest())
                                        .andDo(print())
                                        .andReturn().getResponse().getContentAsString(StandardCharsets.UTF_8);
